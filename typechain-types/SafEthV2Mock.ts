...
export interface SafEthV2MockInterface extends utils.Interface {
  functions: {
    "addDerivative(address,uint256)": FunctionFragment;
    "adjustWeight(uint256,uint256)": FunctionFragment;
    "adminWithdrawDerivative(uint256,uint256)": FunctionFragment;
    "adminWithdrawErc20(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "adminWithdrawDerivative",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface SafEthV2Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafEthV2MockInterface;
  ...
  callStatic: {
    ...
    newFunction(overrides?: CallOverrides): Promise<void>;
