...
export interface WstEthInterface extends utils.Interface {
  functions: {
    "LIDO_CRV_POOL()": FunctionFragment;
    "STETH_TOKEN()": FunctionFragment;
    "WST_ETH()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "LIDO_CRV_POOL",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "STETH_TOKEN",
    values?: undefined
  ): string;
...
export interface WstEth extends BaseContract {
  ...
  functions: {
    LIDO_CRV_POOL(overrides?: CallOverrides): Promise<[string]>;

    STETH_TOKEN(overrides?: CallOverrides): Promise<[string]>;

    WST_ETH(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    LIDO_CRV_POOL(overrides?: CallOverrides): Promise<BigNumber>;

    STETH_TOKEN(overrides?: CallOverrides): Promise<BigNumber>;

    WST_ETH(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    LIDO_CRV_POOL(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    STETH_TOKEN(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    WST_ETH(overrides?: CallOverrides): Promise<PopulatedTransaction>;
