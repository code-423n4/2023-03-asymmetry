...
export interface RocketTokenRETHInterfaceInterface extends utils.Interface {
  functions: {
...
export interface RocketTokenRETHInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RocketTokenRETHInterfaceInterface;
