...
import type { ILockedCvx, ILockedCvxInterface } from "../ILockedCvx";
  ...
  },
  {
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct ILockedCvx.LockedBalance[]",
        name: "lockData",
        type: "tuple[]",
      },
    ],
...
export class ILockedCvx__factory {
  static readonly abi = _abi;
  static createInterface(): ILockedCvxInterface {
    return new utils.Interface(_abi) as ILockedCvxInterface;
  }
  static connect(
    address: string,
