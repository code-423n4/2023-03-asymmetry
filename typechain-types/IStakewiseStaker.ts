...
export interface IStakewiseStakerInterface extends utils.Interface {
  functions: {
...
export interface IStakewiseStaker extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IStakewiseStakerInterface;
