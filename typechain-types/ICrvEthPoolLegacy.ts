...
export interface ICrvEthPoolLegacyInterface extends utils.Interface {
  functions: {
...
export interface ICrvEthPoolLegacy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICrvEthPoolLegacyInterface;
